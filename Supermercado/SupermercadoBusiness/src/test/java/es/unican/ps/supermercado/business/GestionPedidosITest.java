...
public class GestionPedidosITest {
	...
	public static void initContainer() throws Exception {
		...
		//ec.getContext().lookup("java:global/<nombreEAR>/<nombreEJB>!myBeans.<Interfaz>"
		sut = (GestionPedidos) ec.getContext().lookup("java:global/Supermercado/es.unican.ps-SupermercadoBusiness-0.0.1-SNAPSHOT/GestionPedidos"
				+ "!"
